...
mod tests {
    ...
    fn test_pad_to_power_of_two_basic() {
        ...
        let mut values = vec![
            Val::from_u64(1), Val::from_u64(10), // row 0: [value=1, index=10]
            Val::from_u64(2), Val::from_u64(11), // row 1: [value=2, index=11]
            Val::from_u64(3), Val::from_u64(12), // row 2: [value=3, index=12]
        ];
        let width = 2;
    ...
    fn test_pad_to_power_of_two_already_power_of_two() {
        ...
        let mut values = vec![
            Val::from_u64(1), Val::from_u64(2),
            Val::from_u64(3), Val::from_u64(4),
            Val::from_u64(5), Val::from_u64(6),
            Val::from_u64(7), Val::from_u64(8),
        ];
    ...
    fn test_pad_witness_to_power_of_two_monotonic_indices() {
        ...
        let mut values = vec![
            Val::from_u64(10), Val::from_u64(0), // row 0: [value=10, index=0]
            Val::from_u64(20), Val::from_u64(1), // row 1: [value=20, index=1]
            Val::from_u64(30), Val::from_u64(2), // row 2: [value=30, index=2]
        ];
        let width = 2;
        let original_height = 3;
    ...
    fn test_pad_witness_extension_field() {
        ...
        let mut values = vec![
            ...
            Val::from_u64(1), Val::from_u64(2), Val::from_u64(3), Val::from_u64(4), Val::from_u64(0),
            // Row 1: [b0, b1, b2, b3, index=1]
            Val::from_u64(5), Val::from_u64(6), Val::from_u64(7), Val::from_u64(8), Val::from_u64(1),
            // Row 2: [c0, c1, c2, c3, index=2]
            Val::from_u64(9), Val::from_u64(10), Val::from_u64(11), Val::from_u64(12), Val::from_u64(2),
        ];
        let width = 5;
        let original_height = 3;
