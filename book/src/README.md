...
- **[Architecture & Internals](./architecture_and_internals/construction.md)** — How the fixed recursive verifier is built: the execution IR, shared witness memory model, operation-specific chips, circuit building pipeline, trace generation, and Poseidon2-based hashing.
