            ...
            PreprocessedColumns {
                primitive: vec![
                    ...
                    vec![
                        ...
                        F::ONE, F::ZERO, F::ZERO, F::ZERO, F::ZERO, f(1), F::ZERO, f(3),
                        F::ONE, F::ZERO, F::ONE, F::ONE,
                        // add(3, 2, 4): forward, a=3(defined), c=0(defined)
                        F::ONE, F::ZERO, F::ZERO, F::ZERO, f(3), f(2), F::ZERO, f(4),
                        F::ONE, F::ZERO, F::ONE, F::ONE,
                        // mul(4, 2, 5): forward, a=4(defined), c=0(defined)
                        F::ZERO, F::ZERO, F::ZERO, F::ZERO, f(4), f(2), F::ZERO, f(5),
                        F::ONE, F::ZERO, F::ONE, F::ONE,
                    ],
                ],
                non_primitive: HashMap::new(),
        ...
        assert_eq!(
            ...
            PreprocessedColumns {
                primitive: vec![
                    ...
                    vec![
                        F::ONE, F::ZERO, F::ZERO, F::ZERO, F::ZERO, f(15), F::ZERO, f(5),
        ...
        assert_eq!(
            ...
            PreprocessedColumns {
                primitive: vec![
                    ...
                    vec![
                        F::ZERO, F::ZERO, F::ONE, F::ZERO, F::ZERO, f(1), f(2), f(3),
                        F::ONE, F::ZERO, F::ONE, F::ONE,
                    ],
                ],
                non_primitive: HashMap::new(),
